...
public class Action extends TestBase implements ActionInterface {
	...
	public boolean findElement(WebDriver driver, WebElement ele) {
		...
		try {
			...
			if (flag) {
				...
				System.out.println("Unable to locate element at" + ele.getText());
			}
		}
		return flag;
	}
	...
	public boolean selectBySendkeys(String value, WebElement ele) {
		...
		try {
			...
			if (flag) {
				System.out.println("Select value from the DropDown" + ele.getText() + "    " + value);
			} else {
				System.out.println("Not Selected value from the DropDown" + ele.getText() + "    " + value);
	...
	public boolean selectByIndex(WebElement element, int index) {
		...
		try {
			...
			if (flag) {
				System.out.println("Option selected by Index" + element.getText() + "    " + index);
			} else {
				System.out.println("Option not selected by Index" + element.getText() + "    " + index);
			}
		}
	}
	...
	public boolean selectByValue(WebElement element, String value) {
		...
		try {
			...
			if (flag) {
				System.out.println("Option selected by Value" + element.getText() + "    " + value);
			} else {
				System.out.println("Option not selected by Value" + element.getText() + "    " + value);
			}
		}
	}
	...
	public boolean selectByVisibleText(String visibletext, WebElement ele) {
		...
		try {
			...
			if (flag) {
				System.out.println("Option selected by VisibleText" + ele.getText() + "    " + visibletext);
			} else {
				System.out.println("Option not selected by VisibleText" + ele.getText() + "    " + visibletext);
			}
		}
	}
